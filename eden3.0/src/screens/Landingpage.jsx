...
const AnimatedButton = () => {
	...
	return (
		<button  onPointerEnter={onPointerEnter} onPointerLeave={onPointerExit} onPointerDown={handleClick} onPointerUp={onPointerUp} className="touch-none relative outline-none flex items-center box-border">
